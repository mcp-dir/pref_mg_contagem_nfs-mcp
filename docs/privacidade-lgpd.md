...
Prefeitura MG Contagem: NFS-e (Nota Fiscal Eletrônica de Serviços) segue a LGPD (Lei nº 13.709/2018).
...
Acessar, corrigir, eliminar, portar, revogar consentimento. Contato: [pref_mg_contagem_nfs@mcp.ai](mailto:pref_mg_contagem_nfs@mcp.ai). Reclamações: [ANPD](https://www.gov.br/anpd/pt-br).
